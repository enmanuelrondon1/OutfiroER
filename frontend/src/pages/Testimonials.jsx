    ...
    <div>
      <div className="bg-primary mb-16 ">
        <div className="max-padd-container py-10">
          {/* container */}
          <div className="grid grid-cols-1 lg:grid-cols-[1fr,3fr] gap-20 mb-16 rounded-2xl ">
            {/* left side */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-7 ">
              ...
              <div className="flex flex-col gap-1 rounded-lg p-4 bg-white ">
                ...
                <p className="text-justify">
                  This is a review of a product that I have used and liked. It
                  has been very helpful in my work and I would recommend it to
                  others. It is very easy to use and understand, and the results
                  are great.
                </p>
                ...
                <div className="flexBetween">
                  <div className="flexCenter gap-x-2 ">
                    <img
                      ...
                      className="rounded-full "
                    />
                    <h5 className="bold-14">Izabella Strees</h5>
                  </div>
                  <div className="bg-secondary text-white rounded-full flexCenter gap-x-2 p-1 px-2 text-xs font-semibold">
                    <FaCheck />
                    Verified
