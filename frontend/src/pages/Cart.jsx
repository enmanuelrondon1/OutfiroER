...
export const Cart = () => {
  ...
  const increment = (id, size) => {
    ...
    updatedQuantity(id, size, newValue);
  };
                  ...
                  <div className="flex items-center gap-x-3 ">
                    <div className="flex items-start gap-6 ">
                      <img
                        ...
                        alt="Image"
                        className="w-24 sm:w-18 rounded "
                      />
                    </div>
                    <div className="flex flex-col w-full">
                      <div className="flexBetween ">
                        ...
                        <FaRegWindowClose
                          onClick={() =>
                            updatedQuantity(item._id, item.size, 0)
                          }
                          className="cursop-pointer text-secondary "
                        />
                      </div>
                      <p className="bold-14 my-0.5">{item.size} </p>
                      <div className="flexBetween ">
                        <div className="flex items-center ring-1 ring-slate-900/5 rounded-full ooverflow-hidden bg-primary ">
                          <button
                        ...
                        <h4 className="h4 ">
                          {currency}
                          {productData.price * quantities[key]}.00
                        </h4>
                      </div>
                    </div>
                  </div>
